...
<?php
  if(isset($_POST['email'])){
	...
	$receiver="e.philippe@table-tactile.fr,contact@table-tactile.fr,c.laporte@table-tactile.fr,f.carpentier@elecom.fr,s.rousseaux@elecom.fr,guillaume.gervat@table-tactile.fr";
